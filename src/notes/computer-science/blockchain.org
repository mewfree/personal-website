...
Entities behind it (Archblock/TrustToken/TrueCoin) filed Chapter 11 bankruptcy March 2026 over a reserve-payment dispute with Techteryx; token itself still circulating, reserve ratio raised to 100% (US) in May 2026
...
+FTX+ / Mango / Drift comparison http://www.platyperps.com/ — FTX defunct (collapsed Nov 2022), Mango Markets also defunct (hacked 2022, SEC-forced wind-down), comparison stale
