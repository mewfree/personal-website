...
- =Selection Bias=: insurance company might not see all the risk parameters. Health insurance tends to attrack sick people.
...
Starting in the 19th centure, information technology started to develop.
...
People in business are overly influenced by the random successed of themselves or others.
...
**** Anchoring
A tendancy in ambiguous situations to allow one's decisions to be affected by some anchor.
...
Lack of empthy, incapacity for intimacy.
...
Controversy: with recent real estate price increases, LTV has declined below 80% for many homeowners still paying for mortage insurance.
...
Sequential-pay CMOs (first created in 1983): first tranche received first principal payments, after is is paid off the second tranch receives principal payments.
...
DPPs are "flow-through vehicles", investors report earlings and losses on their personal taxes.
...
- GAAP defines "Net Income" (bottom line) and "Operating Income" (revenue minust cost of doing business)
...
- Protects customers of brokerage firm or clearinhouse against failure up to $500k per account, $100k for cash
...
**** G20 Countries
- G7 + Russia (G8) + Argentina, Australia, Brazil, China, European Union, India, Indonesia, Mexico, Saudi Arabia, South Africa, Soutk Korea, Turkey
- Founded in 2008
...
People usually don't really know about derivates markets.
Therefore, there is a public distrust towards derivates markets.
...
- Trigerred sharp recession around the world
...
- Iran-Iraq war eruptos in 1980, disrupts oil supplies
...
- Goverment has sold from reserves on a number of occasions since 2000 when price triggers were hit
...
- Cash settlment rather than physical delivery
...
- Bought deals (or "Firm commitment offering"): the underwriter aggres to buy all shares that are not sold
...
Fiduciaries must act with the care, skill, prudence and diligence under the circumstances then prevailing that a prudent man acting in a like capacity and familiar with such matters would use in the coonduct of an enterprise of a like character and with like aims
**** Dodd-Frank Act (2010)
...
**** Personal Bankruptcy
- Every individual is like a business with the government as a partial shareholder, because it allows you to take risks and then decalre personal bankruptcy if it goes badly
...
- Unemployment insurance in the UK by Lloyd Geroges in 1911
...
- First principle of this course: you should have pruposes beyond making money, beyond abstract finance
...
- 42% of all nonprofits have a formal executive bonus system in palce and the percentage is increasing
- Nonprofits have to compete with for-profits

**** Why Set Up a Nonprofit?
- It may not be much different to you than setting up a for prodit, and it gives you the moral high ground
- Dean Karlan at Yale Innovations for Poverty Action founde in 2002. $25M income in 2010, staff of 500 people.
...
- Halfway between for-prodit and non-profit
...
- Regulations represent a common consense and will survivor changes in government
